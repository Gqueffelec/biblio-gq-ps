insert into biblio_app.categorie (nom,label,information_technique)values ('Roman','ROM','Informations à venir');
insert into biblio_app.categorie (nom,label,information_technique)values ('Bande dessinée','BD','Informations à venir');
insert into biblio_app.categorie (nom,label,information_technique)values ('Mangas','MNG','Informations à venir');
insert into biblio_app.categorie (nom,label,information_technique)values ('Encyclopédies','ROM','Informations à venir');
insert into biblio_app.categorie (nom,label,information_technique)values ('Dictionnaires ','ROM','Informations à venir');
...
insert into biblio_app.livre (id_categorie,titre,date_edition ,prix ,label ,stock )values ('4',"Encyclopædia Britannica",STR_TO_DATE("1990,4,04", "%Y,%m,%d) ,'30','ENCR','6');
