				...
				<div class="collapse navbar-collapse" id="navbarNavDropdown">
					<ul class="navbar-nav">
						<li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#"
								id="navBarDropdownLivre" data-toggle="dropdown" aria-haspopup="true"
						...
						<li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#"
								id="navBarDropdownCategorie" data-toggle="dropdown" aria-haspopup="true"
								aria-expanded="false">Gestion des
								Catégories </a>
							<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
								<button class="btn btn-outline-success ml-5 my-2 my-sm-0" type="button"
									data-toggle="modal" data-target="#newCategorie" id="newCategorieButton">Ajouter une
									catégorie</button>
								<button class="btn btn-outline-success ml-5 my-2 my-sm-0" type="button"
									data-toggle="modal" data-target="#updateCategorie"
									id="updateCategorieButton">Modifier un catégorie</button>
								<button class="btn btn-outline-success ml-5 my-2 my-sm-0" type="button"
									data-toggle="modal" data-target="#removeCategorie"
			...
			<div class="modal fade" id="updateCategorie" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-secondary" data-dismiss="modal">Fermer</button>
							<button type="button" class="btn btn-primary" id="MAJCategorie">Mettre à jour</button>
						</div>
					</div>
				</div>
			</div>
